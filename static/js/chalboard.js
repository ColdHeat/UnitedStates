...
function updateChalWindow(obj) {
    $.get(script_root + '/themes/UnitedStates/static/js/templates/challenges/'+obj.type+'/'+obj.type+'-challenge-modal.hbs', function(template_data){
        $('#chal-window').empty();
        ...
        $.getScript(script_root + '/themes/UnitedStates/static/js/templates/challenges/'+obj.type+'/'+obj.type+'-challenge-script.js',
            function() {
                // Handle Solves tab
